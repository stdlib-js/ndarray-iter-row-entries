...
```javascript
import nditerRowEntries from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-iter-row-entries@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-iter-row-entries/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/ndarray-iter-row-entries/actions/workflows/test.yml?query=branch:v0.2.3
